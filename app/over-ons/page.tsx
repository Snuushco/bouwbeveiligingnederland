...
export const metadata: Metadata = {
  ...
  description: 'Leer meer over Bouwbeveiliging Nederland, onderdeel van Praesidion Security B.V. Erkend beveiligingsbedrijf met vergunningnummer ND 8968.',
  openGraph: {
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '3rem' }}>
            ...
            <div style={{ background: '#fff', borderRadius: '12px', padding: '2rem', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', alignSelf: 'start' }}>
              ...
              <div style={{ color: '#555', lineHeight: 2 }}>
                ...
                <p><strong>Vergunning:</strong> ND 8968</p>
        ...
        <section style={{ background: '#fff', padding: '3rem 1rem' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
              {[
                {
                  title: 'Beveiligingsvergunning ND 8968',
